...
.FileName = "RegBat.bat"
.Filter = "MS-DOS批处理文件(*.bat)|*.bat"
.ShowSave
End With
If CommonDialog1.FileName <> "" Then
If Dir(Me.CommonDialog1.FileName) = "" Then
Open CommonDialog1.FileName For Output As 1
For filewrite = 0 To File1.ListCount - 1
If Left(Dir1.path, 1) <> "\" Then
Print #1, "regsvr32 /s " & Chr(34) & Dir1.path & "\" & File1.List(filewrite) & Chr(34)
Else
Print #1, "regsvr32 /s " & Chr(34) & Dir1.path & File1.List(filewrite) & Chr(34)
End If
Next
...
End If
Else
MsgBox "请指定要保存的文件名!", vbCritical, "Error"
End If
If 1 = 2 Then
With Form10
.Top = Form1.WebBrowser1.Top + Form1.Top + 651
...
For filewrite = 0 To File1.ListCount - 1
If Left(Dir1.path, 1) <> "\" Then
Print #1, "regsvr32 /s /u " & Chr(34) & Dir1.path & "\" & File1.List(filewrite) & Chr(34)
Else
Print #1, "regsvr32 /s /u " & Chr(34) & Dir1.path & File1.List(filewrite) & Chr(34)
End If
Next
...
Label10.Caption = Int(ream * Me.RegSvr.Interval / 1000) + 1
Label12.Caption = ream
ProgressBar1.Value = unregsvrvrt
